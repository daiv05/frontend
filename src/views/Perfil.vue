...
<main class="profile-page">
    <section class="relative block h-500-px">
        <div class="absolute top-0 w-full h-full bg-center bg-cover" style="
                background-image: url('https://vojislavd.com/ta-template-demo/assets/img/profile-background.jpg');
            ">
    ...
    <section class="relative py-16 bg-blueGray-200">
        ...
        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-64">
            ...
            <div class="flex flex-wrap justify-center">
                ...
                <div class="relative">
                    <img alt="..." src="https://miro.medium.com/max/2400/1*TRBxbUzOQshuIvZZ3jlESQ.png" class="shadow-xl rounded-full h-auto align-middle border-none absolute -m-16 -ml-20 lg:-ml-16 max-w-120-px">
                </div>
                </div>
            ...
            <div class="text-center mt-12">
                ...
                <i class="fas fa-user mr-2 text-lg text-blueGray-400"></i>27 Años
                </div>
                <div class="mb-2 text-blueGray-600">
                <i class="fas fa-phone mr-2 text-lg text-blueGray-400"></i> 72863628
                </div>
            </div>
            <div class="mt-10 py-10 border-t border-blueGray-200 text-center">
                ...
                <div class="w-full lg:w-9/12 px-4">
                   ...
                   Lorem ipsum dolor sit, amet consectetur adipisicing elit. Atque tempore at dolore veniam accusamus iure quis, quasi sed voluptatibus repellat autem quidem totam fugiat ducimus ipsam a vitae aliquid neque?
                    </p>
