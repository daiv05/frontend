        ...
        <div  class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg -mt-64">
            ...
            <div  class="text-center mt-12">
                <h3 class="text-4xl font-semibold leading-normal mb-2 text-blueGray-700 mb-2">
                    {{perfil.nombre_user}} {{perfil.apellidos_user}}
                </h3>
                <div class="text-sm leading-normal mt-0 mb-2 text-blueGray-400 font-bold uppercase">
                <i class="fas fa-map-marker-alt mr-2 text-lg text-blueGray-400"></i>
                    {{perfil.ciudad.nombre_ciudad}}, {{perfil.ciudad.departamento.nombre_depa}}
                </div>
            ...
            <div class="mt-10 py-10 border-t border-blueGray-200 text-center">
                ...
                <div class="border pl-4 pt-4 ">
                    ...
                    <ul class="space-y-1 max-w-md list-disc list-inside text-gray-500 dark:text-gray-400 mt-5">
                        <li>
                           saldksadjalskdjlsakdslakdljskdlollllllll
                        </li>
                        <li>
                            klajsdkjsadksadksajdksjdsdlajdlllllllll
                        </li>
                        <li>
                            kajsdkajsdkalsdaslkdjsalkdjlskdllllllll
                        </li>
                    </ul>
                </div>
                <div class="border pl-4 pt-4 ">
