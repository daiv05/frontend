<template>
  <div>
    <!--NAVBAR SUPERIOR-->
    <div
      class="sticky z-10 top-0 h-16 border-transparent bg-gray-900 lg:py-2.5"
    >
  ...
  <img class="h-56 w-full object-cover mt-2" :src = "this.$store.state.ruta_foto + post.ruta_foto" alt="">
  <div class="flex items-center justify-between px-4 py-2 bg-gray-900">
    <h1 class="text-gray-200 font-bold text-xl">${{post.precio}}</h1>
    <button class="px-3 py-1 bg-gray-200 text-sm text-gray-900 font-semibold rounded">Mas información</button>
  </div>
</div>
          </div>
       </div>
