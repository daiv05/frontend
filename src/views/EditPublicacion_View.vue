            ...
            <div class="mt-5 md:col-span-4 md:mt-0">
                ...
                <form action="#" method="POST">
                    ...
                    <div class="shadow sm:overflow-hidden sm:rounded-md">
                        <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <select v-model="depas" name="departamento" id="departamento_id"
                            ...
                            <div class="text-left text-sm">
                                ...
                                <VueMultiselect class="text-sm" v-model="amenis" :options="API_Amenidad"
                            ...
                            <div class="grid grid-cols-4 gap-2 block-inline">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        ...
                                        <input type="number" name="renta" id="rent"
                                            class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                ...
                                <div class="col-span-2">
                                    <label for="ocupo" class="block text-left text-sm font-medium text-gray-700">Max.
                                        Ocupantes</label>
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <input type="number" name="ocupantes" id="ocu"
                                            class="block w-full flex-1 rounded-none rounded-r-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                        ...
                        <div class="bg-gray-50 px-4 py-3 text-justify sm:px-6">
                            <button type="submit"
                                class="inline-flex justify-left rounded-md border border-transparent bg-red-600 py-2 px-4 text-sm font-medium text-white 
    ...
    methods: {
        async getCiudadFiltro() {
            ...
            for (let i = 0; i < this.API_Ciudad.length; i++) {
                if (this.API_Ciudad[i].departamento.nombre_depa == this.depas) {
