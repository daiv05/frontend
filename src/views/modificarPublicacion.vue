                        ...
                        <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <img :src="fotito.foto_lugar" width="20%">
                                </div>
                            </div>
                        </div>
    ...
    methods: {
        ...
        getPublicacionFiltro() {
            for (let i = 0; i < this.API_Publicacion.length; i++) {
                if (this.API_Publicacion[i].perfil == this.Perfil_Logueado.perfil_id) {
                    console.log("PUBLICACION A MOD " + this.API_Publicacion[i])
            ...
            console.log("Datos obtenidos de la publicacion" + this.Perfil_Logueado.perfil_id + " --" + this.API_Publicacion[0])
        },

        getFotoFiltro(){
            for (let i = 0; i < this.API_Foto.length; i++) {
                if (this.API_Foto[i].publicacion == this.publi_creada.id) {
                    this.fotito = this.API_Foto[i].foto_lugar;
                }
            }
