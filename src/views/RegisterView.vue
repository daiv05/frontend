        ...
        <div class="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
          ...
          <form class="formulario" @submit.prevent="submitForm()">
            ...
            <div class="mb-6">
              ...
              <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert" id="alert" v-if="errors.name">
             ...
             <div class="mb-6">
              ...
              <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert" id="alert" v-if="errors.lastName">
            ...
            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert" id="alert" v-if="errors.genero">
              ...
              <div class="mb-6">
                ...
                class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                id="user"
                placeholder="roomate@gmail.com"/>
                
              <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert" id="alert" v-if="errors.email">
