    ...
    <div class="fixed flex z-40">
        ...
        <div class="absolute flex top-0 h-screen z-20"
            ...
            <button @click.prevent="toggle()"
                class="w-12 h-48 p-1 my-auto rounded-lg text-white bg-sky-900 text-center focus:outline-none hover:bg-gray-100 transition-color duration-300">
                <span :class="[right ? '-rotate-90' : 'rotate-90']" class="block origin-center font-bold">
                    Menú
                </span>
            </button>
